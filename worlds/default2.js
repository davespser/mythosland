...
translation: [74.59321284540101, -3.122224290935451, -90.6360272312568],
    scale: [0.6260517966757239, 0.6260517966757239, 0.6260517966757239],
    rotation: [-0.0027712006237080858, -0.9999483213523324, 0.006166950236370461, 0.007592351186397894],
                shadow: true,
                singleSided: true,
                noFog: true,
                type: "3d",
	...
	{
       card: {
                dataLocation: "./assets/3D/estructura.glb",
                dataScale: [1,1,1],
                fileName: "/estructura.glb",
                layers: [
                    "walk", "pointer"
                ],
                modelType: "glb",
                name: "/estructura.glb",
     translation: [77.65233541625136, -3.531588386086254, -97.24996708332382],
    scale: [0.46775149465878235, 0.46775149465878235, 0.46775149465878235],
    rotation: [-0.006303120885353464, -0.7067129575652793, 0.002445709553346581, 0.7074680803974274],
                shadow: true,
                singleSided: true,
                noFog: true,
                type: "3d",
        	...
        	{
       card: {
                dataLocation: "./assets/3D/estructura2.glb",
                dataScale: [1,1,1],
                fileName: "/estructura2.glb",
                layers: [
                    "walk", "pointer"
                ],
                modelType: "glb",
                name: "/estructura2.glb",
  translation: [78.3209901882033, -4.427274689395752, -104.24251524681337],
    scale: [0.46775149465878235, 0.46775149465878235, 0.46775149465878235],
    rotation: [-0.006303120885353464, -0.7067129575652793, 0.002445709553346581, 0.7074680803974274],
                shadow: true,
                singleSided: true,
