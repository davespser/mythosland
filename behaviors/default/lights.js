class LightPawn {
    setup() {
        ...
        const ambient = new THREE.AmbientLight( 0xd3d3d3, .05 );
        group.add(ambient);
        this.lights.push(ambient);

        const sun = new THREE.DirectionalLight( 0xd3d3d3, 0.1);
        sun.position.set(180, 150, -120);
        sun.castShadow = true;
        ...
        const blueLight = new THREE.DirectionalLight(0xd3d3d3, 0);
        blueLight.position.set(-25, 100, 20);
        group.add(blueLight);
        this.lights.push(blueLight);

        const redLight = new THREE.DirectionalLight(0xd3d3d3, 0);
        redLight.position.set(-25, 100, 20);
        group.add(redLight);
